...
resource "databricks_service_principal_federation_policy" "github_cicd_test" {
  ...
  oidc_policy = {
    issuer        = "https://token.actions.githubusercontent.com"
    subject_claim = "job_workflow_ref"
    #subject       = "GeraldMonticelli/northmart360/.github/workflows/oidc-auth-test.yml@refs/heads/test/databricks-oidc-auth"
...
resource "databricks_service_principal_federation_policy" "github_cicd_release_validation_test" {
  provider = databricks.account
  ...
  oidc_policy = {
    issuer        = "https://token.actions.githubusercontent.com"
    subject_claim = "job_workflow_ref"
    subject       = "GeraldMonticelli/northmart360/.github/workflows/release-validation-test.yml@refs/heads/main"
...
resource "databricks_service_principal_federation_policy" "github_cicd_pr_validation_workload" {
  provider = databricks.account
  ...
  oidc_policy = {
    issuer        = "https://token.actions.githubusercontent.com"
    subject_claim = "job_workflow_ref"
    subject       = "GeraldMonticelli/northmart360/.github/workflows/30-pr-workload-validation.yml@refs/heads/main"
...
resource "databricks_service_principal_federation_policy" "github_cicd_databricks_test_discovery" {
  provider = databricks.account
  ...
  oidc_policy = {
    issuer        = "https://token.actions.githubusercontent.com"
    subject_claim = "job_workflow_ref"
    subject       = "GeraldMonticelli/northmart360/.github/workflows/databricks-test-discovery.yml@refs/heads/main"
